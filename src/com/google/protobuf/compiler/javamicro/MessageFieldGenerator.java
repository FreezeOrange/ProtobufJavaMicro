 ...
 */
public class MessageFieldGenerator extends FieldGenerator {
    private Descriptors.FieldDescriptor fieldDescriptor;
    private MessageFieldVariables messageFieldVariables;

    public MessageFieldGenerator(Descriptors.FieldDescriptor fieldDescriptor, Params params) {
        super(params);
    ...
    public void generateMembers(StringBuilder code) {
        messageFieldVariables.codeGenerate(code, "message_field_members.st");
    }

    @Override
    public void generateMergingCode(StringBuilder code) {
        messageFieldVariables.codeGenerate(code, "message_field_merging_code.st");
    }

    @Override
    public void generateParsingCode(StringBuilder code) {
        messageFieldVariables.codeGenerate(code, "message_field_parsing_code.st");
    }

    @Override
    public void generateSerializationCode(StringBuilder code) {
        messageFieldVariables.codeGenerate(code, "message_field_serialization_code.st");
    }

    @Override
    public void generateSerializedSizeCode(StringBuilder code) {
        messageFieldVariables.codeGenerate(code, "message_field_serialization_size_code.st");
    }
